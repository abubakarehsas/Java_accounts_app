        ...
        if (name.equals("")|| mobileNum.equals("") ||  address.equals("") || name.equals("Account Holder Name") || address.equals("Address") || mobileNum.equals("Mobile Number")) {
            ...
            SwingWorker worker = new SwingWorker() {
                ...
                protected Object doInBackground() throws Exception {
                  ...
                  boolean status = accountServices.updateAccountHolderDetail(id, name, mobileNum, address);
                  
                  if (status == true) {
                    JOptionPane.showMessageDialog(txtAddress, "Account detail updated sucessfully");
                        txtName.setText("Account Holder Name");
                    ...
                    frame.hideMyForms();
                    frame.hideBtnThree();
                    frame.showAccountHolderDetail();
                } else {
                    JOptionPane.showMessageDialog(txtAddress, "Account detail not updated");
                }
...
void displayInfo(String nameValue,String mobileValue,String addressValue, String accountId) {

        txtName.setText(nameValue);
        txtMobileNum.setText(mobileValue);
